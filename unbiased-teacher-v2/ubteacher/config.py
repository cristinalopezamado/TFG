...
def add_ubteacher_config(cfg):
    ...
    #Configuracion de asignacion simota
    _C.MODEL.SIMOTA_ASSIGNMENT=True
    _C.MODEL.SIMOTA_COEF_REG= 1.5
    _C.MODEL.SIMOTA_RADIUS=10
    _C.MODEL.SIMOTA_Q_DYNAMICK=20
    ...
    #pcb
    _C.TEST.PCB_ENABLE= True
    _C.TEST.PCB_MODELPATH= "detectron2://ImageNetPretrained/MSRA/R-50.pkl"
    _C.TEST.PCB_MODELTYPE= "resnet"
    _C.TEST.PCB_ALPHA= 0.50
    _C.TEST.PCB_UPPER= 1.0
    _C.TEST.PCB_LOWER= 0.05
    ...
    #para reducir el porcentaje de no supervisado para hacer pruebas
    _C.DATALOADER.REDUCE_UNLABEL_DATA=False
    _C.DATALOADER.UNLABEL_PERCENT_USE=25.0
    ...
    _C.SEMISUPNET.MIN_BBOX_THRESHOLD = 0.0
    _C.SEMISUPNET.MAX_BBOX_THRESHOLD = 1.0
    _C.SEMISUPNET.RANDOM_MAX_THRESHOLD=False
    _C.SEMISUPNET.BBOX_CTR_THRESHOLD = 0.5
    _C.SEMISUPNET.FLEXIBLE_THRESHOLD= False
    _C.SEMISUPNET.IOU_FLEXMATCH_NMS=0.5
    _C.SEMISUPNET.FLEXMATCH_NMS=False
    _C.SEMISUPNET.FLEX_WARMUP=False
    _C.SEMISUPNET.NUM_ITERS_BEFORE_FLEX=0
    
    _C.SEMISUPNET.IGNORE_REGIONS=False
    _C.SEMISUPNET.THRESHOLD_IGNORE_REGIONS= 0.5
